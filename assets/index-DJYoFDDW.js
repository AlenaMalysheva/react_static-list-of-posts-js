...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>{const{name:t,email:i,body:n}=e;return j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:t})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i})]}),j.jsx("div",{className:"CommentInfo__body",children:n})]})},Tc=({comments:e})=>j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>{if(!e)return j.jsx("div",{children:"No post data available"});const{title:t,body:i,comments:n}=e;return j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:t}),j.jsxs("p",{children:[" Posted by  ",j.jsx(Pc,{user:e.user})]})]}),j.jsx("p",{className:"PostInfo__body",children:i}),j.jsx("hr",{}),n&&n.length>0?j.jsx(Tc,{comments:n}):j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Rc=({posts:e})=>j.jsx("div",{className:"PostList",children:e.map(t=>j.jsx(Mc,{post:t},t.id))}),Dc=()=>{function e(n){return Nc.find(a=>a.id===n)}function t(n){return zc.filter(a=>a.postId===n)}const i=Cc.map(n=>({...n,user:e(n.userId),comments:t(n.id)}));return j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Rc,{posts:i})]})};em(document.getElementById("root")).render(j.jsx(Dc,{}));
